<template>
  <div class="card">
    <div :class="'front-card ' + 'card-' + progressClassFormat(data.progresso)">
      <i
        :class="{
      ...
      <div class="content">
        ...
        <div class="row">
          <div class="row">
            <p class="basic-text" style="margin-right:10px;">Status: <strong> {{ this.progressFormat(data.progresso) }} </strong></p>
...
.card-red{ background-color: rgba(247, 183, 183, 0.979);}
.card-yellow{ background-color: rgba(231, 227, 151, 0.979);}
.card-green{ background-color: rgba(178, 241, 192, 0.979);}
</style>